...
define('NOTION_STAGE_DB',            getenv('NOTION_STAGE_DB') ?: '');
define('NOTION_MASTER_BUEHNEN_DB',   getenv('NOTION_MASTER_BUEHNEN_DB') ?: '');
define('NOTION_KIDS_DB',             getenv('NOTION_KIDS_DB') ?: '');
